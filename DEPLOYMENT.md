# WaterScribe v2 Native Deployment Guide

This document covers the native deployment of WaterScribe v2 on Ubuntu without Docker.
...
- Create PostgreSQL database `waterscribe` and user `waterscribe`
- Create systemd service file `/etc/systemd/system/waterscribe.service`
- Configure nginx reverse proxy in `/etc/nginx/sites-available/waterscribe`
...
DATABASE_URL=postgresql://waterscribe:8umQ915fFLNxvIBTi4zwRa4y@localhost/waterscribe
```
...
- **Password**: waterscribe123 (change this!)
